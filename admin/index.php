...
function EditElement($itemid,$handlername,$id,$label,$tabnum,$redirect='')
{
	...
	$sform = new XoopsThemeForm(_AM_MYJOB_ITEMEDIT, 'itemform', XOOPS_URL.'/modules/myjob/admin/index.php');
...
function ListElements($handler, $id, $lib, $handlername, $tabnum, $redirect, $start)
{
	...
	foreach($elements as $oneelement) {
		...
		$edit="<a title='"._AM_MYJOB_EDIT."' href='".XOOPS_URL.'/modules/myjob/admin/index.php?op=itemedit&itemid='.$oneelement->getVar($id)."&handlertype=".$handlername."&tabnum=".$tabnum.$paramsup."'><img src='".XOOPS_URL."/modules/myjob/images/edit.gif' alt='"._AM_MYJOB_EDIT."'></a>";
		$dele="<a title='"._AM_MYJOB_DELETE."' href='".XOOPS_URL.'/modules/myjob/admin/index.php?op=itemdelete&itemid='.$oneelement->getVar($id)."&handlername=".$handlername."&tabnum=".$tabnum.$paramsup."'".myjob_JavascriptLinkConfirm(_AM_MYJOB_CONF_DELETE)."><img src='".XOOPS_URL."/modules/myjob/images/delete.gif' alt='"._AM_MYJOB_DELETE."'></a>";
...
switch ($op)
{
	...
	case 'viewoffers':
        ...
        if($useoffers) {
			...
			if($offerswaitingcount>0) {
				...
				echo "<img onclick='toggle('toptable'); toggleIcon('toptableicon');' id='offerswaiticon' name='offerswaiticon' src=" . XOOPS_URL . "/modules/myjob/images/close12.gif alt='' /></a>&nbsp;"._AM_MYJOB_OFFERSWAITING."</h4>";
				...
				foreach($offerswaiting as $oneoffre) {
					$class = ($class == 'even') ? 'odd' : 'even';
					$edit="<a title='"._AM_MYJOB_EDIT."' href='".XOOPS_URL.'/modules/myjob/admin/index.php?op=offeredit&offerid='.$oneoffre->getVar('offreid')."'><img src='".XOOPS_URL."/modules/myjob/images/edit.gif' alt='"._AM_MYJOB_EDIT."'></a>";
					$dele="<a title='"._AM_MYJOB_DELETE."' href='".XOOPS_URL.'/modules/myjob/admin/index.php?op=offerdelete&offerid='.$oneoffre->getVar('offreid')."'><img src='".XOOPS_URL."/modules/myjob/images/delete.gif' alt='"._AM_MYJOB_DELETE."'></a>";
					echo "<tr class='".$class."'><td>".xoops_substr($oneoffre->getVar('nomentreprise'),0,$longtit)."</td><td>".formatTimestamp($oneoffre->getVar('datesoumission'))."</td><td>".xoops_substr($oneoffre->getVar('secteuractivite'),0,$longtit)."</td><td>".$types[$oneoffre->getVar('typeposte')]."</td><td>".xoops_substr($oneoffre->getVar('titreannonce'),0,$longtit)."</td><td align='center'>".$edit.' '.$dele."</td></tr>";
				}
				echo '</table><br /><br />';
				echo '</div>';
			}
			...
			echo "<img onclick='toggle('toptable'); toggleIcon('toptableicon');' id='offersvalidicon' name='offersvalidicon' src=" . XOOPS_URL . "/modules/myjob/images/close12.gif alt='' /></a>&nbsp;".sprintf(_AM_MYJOB_LAST_OFFERS,$limit)."</h4>";
			echo "<div id='offersvalid'>";
			echo '<br />';
			echo "<table width='100%' cellspacing='1' cellpadding='3' border='0' class='outer'>";
			echo "<tr><th>"._MYJOB_OFFER_ENTREPRISE."</th><th>"._MYJOB_OFFER_DATESUBMIT."</th><th>"._MYJOB_OFFER_SECTEUR."</th><th>"._MYJOB_OFFER_TYPEPOSTE."</th><th>"._MYJOB_OFFER_DESCRIPTION."</th><th>"._AM_MYJOB_VIEW."</th><th align='center'>"._AM_MYJOB_ACTION."</th></tr>";
			$class='';
			foreach($offres as $oneoffre) {
				$class = ($class == 'even') ? 'odd' : 'even';
				$edit="<a title='"._AM_MYJOB_EDIT."' href='".XOOPS_URL.'/modules/myjob/admin/index.php?op=offeredit&offerid='.$oneoffre->getVar('offreid')."'><img src='".XOOPS_URL."/modules/myjob/images/edit.gif' alt='"._AM_MYJOB_EDIT."'></a>";
				$dele="<a title='"._AM_MYJOB_DELETE."' href='".XOOPS_URL.'/modules/myjob/admin/index.php?op=offerdelete&offerid='.$oneoffre->getVar('offreid')."'><img src='".XOOPS_URL."/modules/myjob/images/delete.gif' alt='"._AM_MYJOB_DELETE."'></a>";
				$unval="<a title='"._AM_MYJOB_UNVALIDATE."' href='".XOOPS_URL.'/modules/myjob/admin/index.php?op=offerunval&offerid='.$oneoffre->getVar('offreid')."'><img src='".XOOPS_URL."/modules/myjob/images/unvalidate.gif' alt='"._AM_MYJOB_UNVALIDATE."'></a>";
				echo "<tr class='".$class."'><td>".xoops_substr($oneoffre->getVar('nomentreprise'),0,$longtit)."</td><td>".formatTimestamp($oneoffre->getVar('datesoumission'))."</td><td>".xoops_substr($oneoffre->getVar('secteuractivite'),0,$longtit)."</td><td>".$types[$oneoffre->getVar('typeposte')]."</td><td>".xoops_substr($oneoffre->getVar('titreannonce'),0,$longtit)."</td><td align='right'>".$oneoffre->getVar('hits')."</td><td align='center'>".$edit.' '.$dele.' '.$unval."</td></tr>";
			}
	...
	case 'offerunval':
		if($useoffers) {
			if(isset($_GET['offerid'])) {
				$offre_handler->unvalidate(intval($_GET['offerid']));
				myjob_updateCache();
				redirect_header('index.php?op=viewoffers',2,_AM_MYJOB_UNVALIDATE_OK);
			} else {
	   			redirect_header('index.php?op=viewoffers',2,_ERRORS);
   				exit();
			}
		}
		break;
	...
	case 'offeredit':
        ...
        if($useoffers) {
			...
			$adminside=true;
			include_once XOOPS_ROOT_PATH.'/modules/myjob/include/offer_form.php';
		} else {
			echo '<h1>'._AM_MYJOB_OFFERS_NOUSE.'</h1>';
		}
		break;
	...
	case 'offerdelete':
		if($useoffers) {
	    	if (!isset($_POST['ok'])) {
				...
				$offre = $offre_handler->get($offerid);
        		xoops_confirm( array('op' => 'offerdelete', 'offerid' => $offerid, 'ok' => 1), 'index.php', _AM_MYJOB_WARNING_DELETE_OFFER . '<br />' . $offre->getVar('titreannonce'));
	    	} else {
				...
				myjob_updateCache();
        		redirect_header('index.php?op=viewoffers', 1, _AM_MYJOB_DBUPDATED );
        		exit();
    		}
    	}
		break;
	...
	case 'demandprolongvalid':
		...
		if(isset($_GET['action']) && $_GET['action']=='yes') {
			...
			redirect_header('index.php?op=viewdemands', 2, _AM_MYJOB_DBUPDATED);
		}
	...
	case 'viewdemands':
        ...
        if($usedemands) {
			...
			if($demandswaitingcound>0) {
				...
				echo "<img onclick='toggle('toptable'); toggleIcon('toptableicon');' id='demandswaiticon' name='demandswaiticon' src=" . XOOPS_URL . "/modules/myjob/images/close12.gif alt='' /></a>&nbsp;"._AM_MYJOB_DEMANDSWAITING."</h4>";
				...
				foreach($demandswaiting as $onedemande) {
					$class = ($class == 'even') ? 'odd' : 'even';
					$edit="<a title='"._AM_MYJOB_EDIT."' href='".XOOPS_URL.'/modules/myjob/admin/index.php?op=demandedit&demandid='.$onedemande->getVar('demandid')."'><img src='".XOOPS_URL."/modules/myjob/images/edit.gif' alt='"._AM_MYJOB_EDIT."'></a>";
					$dele="<a title='"._AM_MYJOB_DELETE."' href='".XOOPS_URL.'/modules/myjob/admin/index.php?op=demanddelete&demandid='.$onedemande->getVar('demandid')."'><img src='".XOOPS_URL."/modules/myjob/images/delete.gif' alt='"._AM_MYJOB_DELETE."'></a>";
					echo "<tr class='".$class."'><td align='center'>".$onedemande->getVar('demandid')."</td><td>".formatTimestamp($onedemande->getVar('datesoumission'),'s')."</td><td>".xoops_substr($onedemande->getVar('titreannonce'),0,$longtit)."</td><td>".xoops_substr($onedemande->getVar('nom'),0,$longtit)."</td><td>".xoops_substr($onedemande->getVar('prenom'),0,$longtit)."</td><td align='center'>".$edit.' '.$dele."</td></tr>";
				}
			...
			if(myjob_getmoduleoption('prolongation')) {
				...
				if($cnt>0) {
					...
					echo "<img onclick='toggle('toptable'); toggleIcon('toptableicon');' id='demandsprolongicon' name='demandsprolongicon' src=" . XOOPS_URL."/modules/myjob/images/close12.gif alt='' /></a>&nbsp;"._AM_MYJOB_PROLONGATION_DEMAND."</h4>";
					echo "<div id='demandsprolong'>";
					echo '<br />';
					echo "<table width='100%' cellspacing='1' cellpadding='3' border='0' class='outer'>";
					echo "<tr><th>"._MYJOB_DEMAND_ZONEGEOGRAPHIQUE."</th><th>"._MYJOB_DEMAND_SECTEURACTIVITE."</th><th>"._MYJOB_DEMAND_DESCRIPTION."</th><th>"._MYJOB_DEMAND_NOM."</th><th>"._MYJOB_DEMAND_PRENOM."</th><th align='center'>"._AM_MYJOB_PROLONGATION_EXPIRATION."</th><th align='center'>"._AM_MYJOB_ACTION."</th></tr>";
					$class='';
					...
					foreach($demandes as $onedemande) {
						...
						$edit="<a title='"._AM_MYJOB_EDIT."' href='".XOOPS_URL.'/modules/myjob/admin/index.php?op=demandedit&demandid='.$onedemande->getVar('demandid')."'><img src='".XOOPS_URL."/modules/myjob/images/edit.gif' alt='"._AM_MYJOB_EDIT."'></a>";
						$dele="<a title='"._AM_MYJOB_DELETE."' href='".XOOPS_URL.'/modules/myjob/admin/index.php?op=demanddelete&demandid='.$onedemande->getVar('demandid')."'><img src='".XOOPS_URL."/modules/myjob/images/delete.gif' alt='"._AM_MYJOB_DELETE."'></a>";
						$unval="<a title='"._AM_MYJOB_UNVALIDATE."' href='".XOOPS_URL.'/modules/myjob/admin/index.php?op=demandunval&demandid='.$onedemande->getVar('demandid')."'><img src='".XOOPS_URL."/modules/myjob/images/unvalidate.gif' alt='"._AM_MYJOB_UNVALIDATE."'></a>";
						$prolongok="<a title='"._AM_MYJOB_PROLONGATION_YES."' href='".XOOPS_URL.'/modules/myjob/admin/index.php?op=demandprolongvalid&action=yes&demandid='.$onedemande->getVar('demandid')."'><img src='".XOOPS_URL."/modules/myjob/images/button_ok.png' alt='"._AM_MYJOB_PROLONGATION_YES."'></a>";
						$prolongno="<a title='"._AM_MYJOB_PROLONGATION_NO."' href='".XOOPS_URL.'/modules/myjob/admin/index.php?op=demandprolongvalid&action=no&demandid='.$onedemande->getVar('demandid')."'><img src='".XOOPS_URL."/modules/myjob/images/button_cancel.png' alt='"._AM_MYJOB_PROLONGATION_NO."'></a>";
						...
						echo "<tr class='".$class."'><td><a target='_blank' href='../demande-view.php?demandid=".$onedemande->getVar('demandid')."'>".$libzones."</a></td><td>".$libsecteurs."</td><td>".xoops_substr($onedemande->getVar('titreannonce'),0,$longtit)."</td><td>".xoops_substr($onedemande->getVar('nom'),0,$longtit)."</td><td align='center'>".xoops_substr($onedemande->getVar('prenom'),0,$longtit)."</td><td>".formatTimestamp($onedemande->getVar('dateexpiration'))."</td><td>".$edit.' '.$dele.' '.$unval.' '.$prolongok.' '.$prolongno."</td></tr>";
					}
					echo '</table></div><br />';
				}
			}
			...
			echo "<img onclick='toggle('toptable'); toggleIcon('toptableicon');' id='demandsvalidicon' name='demandsvalidicon' src=" . XOOPS_URL . "/modules/myjob/images/close12.gif alt='' /></a>&nbsp;".sprintf(_AM_MYJOB_LAST_DEMANDS,$limit)."</h4>";
			echo "<div id='demandsvalid'>";
			echo '<br />';
			echo "<table width='100%' cellspacing='1' cellpadding='3' border='0' class='outer'>";
			echo "<tr><th>"._MYJOB_DEMAND_ZONEGEOGRAPHIQUE."</th><th>"._MYJOB_DEMAND_SECTEURACTIVITE."</th><th>"._MYJOB_DEMAND_EXPERIENCE."</th><th>"._MYJOB_DEMAND_TYPEPOSTE."</th><th>"._MYJOB_DEMAND_DESCRIPTION."</th><th>"._MYJOB_DEMAND_NOM."</th><th>"._MYJOB_DEMAND_PRENOM."</th><th align='center'>"._AM_MYJOB_ACTION."</th></tr>";
			$class='';
			foreach($demandes as $onedemande) {
				$class = ($class == 'even') ? 'odd' : 'even';
				$edit="<a title='"._AM_MYJOB_EDIT."' href='".XOOPS_URL.'/modules/myjob/admin/index.php?op=demandedit&demandid='.$onedemande->getVar('demandid')."'><img src='".XOOPS_URL."/modules/myjob/images/edit.gif' alt='"._AM_MYJOB_EDIT."'></a>";
				...
				$tblsecteurs=$demandoffersecteurs_handler->getLibsWithRelation($critere);
				$libsecteurs=join('<br />',$tblsecteurs);
				echo "<tr class='".$class."'><td><a target='_blank' href='../demande-view.php?demandid=".$onedemande->getVar('demandid')."'>".$libzones."</a></td><td>".$libsecteurs."</td><td>".xoops_substr($onedemande->getVar('libelle_experience'),0,$longtit)."</td><td>".$types[$onedemande->getVar('typeposte')]."</td><td>".xoops_substr($onedemande->getVar('titreannonce'),0,$longtit)."</td><td>".xoops_substr($onedemande->getVar('nom'),0,$longtit)."</td><td align='center'>".xoops_substr($onedemande->getVar('prenom'),0,$longtit)."</td><td>".$edit.' '.$dele.' '.$unval."</td></tr>";
			}
			echo "</table><div align='right'>".$pagenav->renderNav().'</div></div><br />';
        } else {
	...
	case 'demandunval':
		if($usedemands) {
			if(isset($_GET['demandid'])) {
				$demande_handler->unvalidate(intval($_GET['demandid']));
				myjob_updateCache();
				redirect_header('index.php?op=viewdemands',2,_AM_MYJOB_UNVALIDATE_OK);
			} else {
	   			redirect_header('index.php?op=viewdemands',2,_ERRORS);
   				exit();
			}
		}
		break;
	...
	case 'demanddelete':
		if($usedemands) {
		    if (!isset($_POST['ok'])) {
				...
				$demande = $demande_handler->get($demandid);
        		xoops_confirm( array('op' => 'demanddelete', 'demandid' => $demandid, 'ok' => 1), 'index.php', _AM_MYJOB_WARNING_DELETE_DEMAND . '<br />' . $demande->getVar('titreannonce'));
	    	} else {
				if (isset($_POST['demandid']) ) {
					$demandid=intval($_POST['demandid']);
				} else {
	    			redirect_header('index.php',2,_ERRORS);
    			exit();
				}
				...
				myjob_updateCache();
        		redirect_header('index.php?op=viewdemands', 1, _AM_MYJOB_DBUPDATED );
        		exit();
    		}
    	}
		break;
	...
	*/
	case 'experience':
		...
		$class = ($class == 'even') ? 'odd' : 'even';
		echo "<tr class='".$class."'><td align='center' colspan='3'><form method='post' action='index.php'><input type='hidden' name='handlername' value='experience'><input type='hidden' name='op' value='additem'><input type='submit' name='go' value='"._AM_MYJOB_ITEMADD."'></form></td></tr>";
    	echo '</table>';
	...
	case 'geo':
		...
		$class = ($class == 'even') ? 'odd' : 'even';
		echo "<tr class='".$class."'><td align='center' colspan='3'><form method='post' action='index.php'><input type='hidden' name='handlername' value='zonegeographique'><input type='hidden' name='op' value='additem'><input type='submit' name='go' value='"._AM_MYJOB_ITEMADD."'></form></td></tr>";
    	echo '</table>';
    	echo "<br /><div align='right'>".$pagenav->renderNav()."</div>";
		break;
	...
	case 'secteurs':
		...
		$class = ($class == 'even') ? 'odd' : 'even';
		echo "<tr class='".$class."'><td align='center' colspan='3'><form method='post' action='index.php'><input type='hidden' name='handlername' value='secteuractivite'><input type='hidden' name='op' value='additem'><input type='submit' name='go' value='"._AM_MYJOB_ITEMADD."'></form></td></tr>";
    	echo '</table>';
    	echo "<br /><div align='right'>".$pagenav->renderNav()."</div>";
		break;
	...
	case 'managesitfam':
		...
		$class = ($class == 'even') ? 'odd' : 'even';
		echo "<tr class='".$class."'><td align='center' colspan='3'><form method='post' action='index.php'><input type='hidden' name='handlername' value='sitfam'><input type='hidden' name='op' value='additem'><input type='submit' name='go' value='"._AM_MYJOB_ITEMADD."'></form></td></tr>";
    	echo '</table>';
    	echo "<br /><div align='right'>".$pagenav->renderNav()."</div>";
		break;
	...
	case 'managetypeposte':
		...
		$class = ($class == 'even') ? 'odd' : 'even';
		echo "<tr class='".$class."'><td align='center' colspan='3'><form method='post' action='index.php'><input type='hidden' name='handlername' value='typeposte'><input type='hidden' name='op' value='additem'><input type='submit' name='go' value='"._AM_MYJOB_ITEMADD."'></form></td></tr>";
    	echo '</table>';
    	echo "<br /><div align='right'>".$pagenav->renderNav()."</div>";
		break;
	...
	*/
	case 'salarytype':
		...
		$class = ($class == 'even') ? 'odd' : 'even';
		echo "<tr class='".$class."'><td align='center' colspan='3'><form method='post' action='index.php'><input type='hidden' name='handlername' value='salarytype'><input type='hidden' name='op' value='additem'><input type='submit' name='go' value='"._AM_MYJOB_ITEMADD."'></form></td></tr>";
    	echo '</table>';
    	echo "<br /><div align='right'>".$pagenav->renderNav()."</div>";
		break;
	...
	*/
	case 'additem':
		...
		echo '<br /><br />';
		$obj_handler=& xoops_getmodulehandler($handlername, 'myjob');
		$sform = new XoopsThemeForm(_AM_MYJOB_ITEMADD, 'additem', XOOPS_URL.'/modules/myjob/admin/index.php', 'post');
	...
	*/
	case 'additemforsave':
		...
		myjob_updateCache();
		if($res) {
			redirect_header('index.php?op='.$op,2,_AM_MYJOB_DBUPDATED);
		} else {
			redirect_header('index.php?op='.$op,3,_AM_MYJOB_DB_NOTUPDATED);
		}
		break;
	...
	*/
	case 'itemsave':
		...
		$item = $obj_handler->get(intval($_POST['itemid']));
		$item->unsetNew();
		...
		unset($item);
		if($res) {
			redirect_header('index.php?op='.$_POST['redirect'], 2, _AM_MYJOB_DBUPDATED);
		} else {
			redirect_header('index.php', 3, _AM_MYJOB_DB_NOTUPDATED);
		}
		break;
	...
	*/
	case 'itemdelete':
		...
		$item = $obj_handler->get(intval($_GET['itemid']));
		$res = $obj_handler->delete($item,true);
		myjob_updateCache();
		if($res) {
			redirect_header('index.php?op='.$_GET['redirect'], 2, _AM_MYJOB_DBUPDATED);
		} else {
			redirect_header('index.php', 3, _AM_MYJOB_DB_NOTUPDATED);
		}
		break;
	...
	case 'itemedit':
		xoops_cp_header();
        myjob_adminmenu(intval($_GET['tabnum']));
        echo '<br/><br />';
		EditElement(intval($_GET['itemid']), $_GET['handlertype'],$_GET['fieldid'],$_GET['fieldlabel'],intval($_GET['tabnum']),$_GET['redirect']);
		break;
	...
	/**
 	...
 	case 'fieldssave':
		...
		myjob_adminmenu(10);
		echo '<br /><br />';
		$fp = fopen($field_name,'w') or die(_AM_MYJOB_FIELDS_ERROR);
		...
		fclose($fp);
		redirect_header('index.php?op=fields',2,_AM_MYJOB_DBUPDATED);
 		break;
	...
	case 'fields':
		...
		include_once XOOPS_ROOT_PATH.'/class/xoopsformloader.php';
		$sform = new XoopsThemeForm(_AM_MYJOB_FIELDS_MANAGER, 'fieldsform', XOOPS_URL.'/modules/myjob/admin/index.php');
