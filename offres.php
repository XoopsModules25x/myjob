...
$xoopsOption['template_main'] = 'myjob_offerindex.tpl';
...
$xoopsTpl->assign('offerscount', sprintf(_MYJOB_OFFERS_COUNT, $offersvalid));            // Nombre total d'offres d'emploi (valid�es)
