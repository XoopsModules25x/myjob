...
$modversion['blocks'][$cptb]['options']     =
    '1|10|50|0|0|0|0';    // 1=Trié par date (2=par lectures), 10=Nombre d'éléments à afficher, 30=Longueur du titre, 0=longueur du texte d'intro, 0=type de poste (0=tous sinon l'id), 0=zone géographique (0=tous sinon l'id), 0=secteur d'activité (0=tous sinon l'id)
$modversion['blocks'][$cptb]['template']    = 'myjob_block_demand_recent.tpl';
...
$modversion['blocks'][$cptb]['options']     =
    '2|10|50|0|0|0|0';    // 1=Trié par date (2=par lectures), 10=Nombre d'éléments à afficher, 30=Longueur du titre, 0=longueur du texte d'intro, 0=type de poste (0=tous sinon l'id), 0=zone géographique (0=tous sinon l'id), 0=secteur d'activité (0=tous sinon l'id)
$modversion['blocks'][$cptb]['template']    = 'myjob_block_demand_top.tpl';
...
$modversion['blocks'][$cptb]['options']     =
    '1|10|50|0|0|0|0';    // 1=Trié par date (2=par lectures), 10=Nombre d'éléments à afficher, 30=Longueur du titre, 0=longueur du texte d'intro, 0=type de poste (0=tous sinon l'id), 0=zone géographique (0=tous sinon l'id), 0=secteur d'activité (0=tous sinon l'id)
$modversion['blocks'][$cptb]['template']    = 'myjob_block_demand_random.tpl';
...
$modversion['blocks'][$cptb]['template']    = 'myjob_block_offer_recent.tpl';
...
$modversion['blocks'][$cptb]['options']     = '1|10|50|0';  // 1=Sort by date, 2=Sort by reads, 10=Elements count, 30=Title's length, 0=teaser
$modversion['blocks'][$cptb]['template']    = 'myjob_block_offer_top.tpl';
...
$modversion['blocks'][$cptb]['options']     = '1|10|50|0';  // 1=Sort by date, 2=Sort by reads, 10=Elements count, 30=Title's length, 0=teaser
$modversion['blocks'][$cptb]['template']    = 'myjob_block_offer_random.tpl';
...
$modversion['blocks'][$cptb]['options']     = '';
$modversion['blocks'][$cptb]['template']    = 'myjob_block_stats.tpl';
...
$modversion['blocks'][$cptb]['template']    = 'myjob_block_demand_xstats.tpl';
...
$modversion['blocks'][$cptb]['options']     = '0|10|0'; // 0=Quoi voir ? (0=types de poste, 1=secteurs, 2=zones géographiques), 10=Nombre d'éléments à voir, 0=trier par compteur ou 1 par libellé
$modversion['blocks'][$cptb]['template']    = 'myjob_block_offer_xstats.tpl';
