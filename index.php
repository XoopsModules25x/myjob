...
$xoopsOption['template_main'] = 'myjob_index.tpl';
...
if (myjob_getmoduleoption('rss')) {
    $link = sprintf("<a href='%s' title='%s'><img src='%s' border=0 alt='%s'></a>", XOOPS_URL . '/modules/myjob/backend.php', _MYJOB_RSSFEED, XOOPS_URL . '/modules/myjob/assets/images/rss.gif', _MYJOB_RSSFEED);
    $link .= sprintf(" <a href='%s' title='%s'><img src='%s' border=0 alt='%s'></a>", XOOPS_URL . '/modules/myjob/atom.php', _MYJOB_ATOMFEED, XOOPS_URL . '/modules/myjob/assets/images/atom.gif', _MYJOB_ATOMFEED);
...
$xoopsTpl->assign('imgurl', XOOPS_URL . '/modules/myjob/assets/images/');
