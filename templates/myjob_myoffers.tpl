...
<{elseif $op=='view'}>
    <table border='0' width='95%'>
        ...
        <tr class="<{cycle values=" even,odd
    "}>">
            <td><a href='demande-view.php?demandid=<{$onedemande.demandid}>' target="_blank"><{$onedemande.zonesgeographiques_libelle}></a></td>
            <td><{$onedemande.secteurid_libelle}></td>
            <td><{$onedemande.experience}></td>
            <td align='center'><{$typesoffres[$onedemande.typeposte]}></td>
            <td><a href='demande-view.php?demandid=<{$onedemande.demandid}>'><{$onedemande.titreannonce}></a></td>
