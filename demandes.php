 ...
 */
include 'header.php';
$xoopsOption['template_main'] = 'myjob_demandeindex.html';
...
$sortorder = isset($_GET['sortorder']) ? intval($_GET['sortorder']) : 0;
$sortfield = isset($_GET['sortfield']) ? intval($_GET['sortfield']) : 0;
