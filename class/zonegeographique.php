...
{
	function MyjobZonegeographiqueHandler($db)
	{	//											Table						Classe				Id
		$this->MjXoopsPersistableObjectHandler($db, 'myjob_zonegeographique', 'zonegeographique', 'zoneid');
	}


	function delete(&$zonegeographique, $force = false)
	{
