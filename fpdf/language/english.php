...
$pdf_config['creator'] = 'MYJOB BASED ON FPDF v1.53';
...
$pdf_config['footerpage'] = _MYJOB_PDF_PAGE;

// For local support sites
define('MYJOB_PDF_FORUM', 'Forum');
define('MYJOB_PDF_TOPIC', 'Topic');
define('MYJOB_PDF_SUBJECT', 'Subject');
define('MYJOB_PDF_AUTHOR', _POSTEDBY);
define('MYJOB_PDF_DATE', _MYJOB_POSTEDON);
